...
# =================== CONSTANT ===================
LFM_BIO_ENABLED = "```تم الآن تمكين last.fm للموسيقى الحالية في السيرة الذاتية.```"
LFM_BIO_DISABLED = "```تم الآن تعطيل last.fm للموسيقى الحالية للسيرة الذاتية. عادت السيرة الذاتية إلى الوضع الافتراضي.```"
LFM_BIO_RUNNING = "```الموسيقى الحالية لـ last.fm إلى السيرة الذاتية قيد التشغيل بالفعل.```"
LFM_BIO_ERR = "```لم يتم تحديد أي خيار.```"
LFM_LOG_ENABLED = "```last.fm تسجيل الدخول إلى bot log ممكّن الآن.```"
LFM_LOG_DISABLED = "```last.fm تسجيل الدخول إلى سجل البوت معطل الآن.```"
LFM_LOG_ERR = "```لم يتم تحديد أي خيار.```"
ERROR_MSG = "```تم إيقاف وحدة last.fm ، وحصلت على خطأ غير متوقع.```"
...
@iqthon.on(admin_cmd(pattern="lastbio (on|off)(?: |$)(.*)"))
...
@iqthon.on(admin_cmd(pattern="lastlog (on|off)(?: |$)(.*)"))
